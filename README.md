...
A Ricardian contract is any human readable and agreeable document, such as a form, signed contract, application, etc. This repository is an example for how a Git repository can be used to manage client contracts and integrate with on-chain proof of contract through Immutable Ecosystem Ricardian Contract NFTs. While this example is public, it is designed to be a private repo used to maintain the completed contracts received by a contract application owner. Replace the example PDF of the Immutable Ecosystem Creator agreement with your use case and within your own private repo. The innovation is to utilize GitHub to privately manage storing client agreements as branches for each completed agreement form. 
