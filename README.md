# Ricardian-Contracts
Example repo for Immutable Ecosystem Ricardian Contracts. Designed to a private repo maintained by the contract application owner. Replace the example PDF of the Immutable Ecosystem Creator agreement with your own agreement within your own private repo. The goal is to use GitHub to manage storing client agreements as branches for each completed agreement form. In your 
